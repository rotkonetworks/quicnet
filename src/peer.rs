...
use anyhow::Result;
use quinn::{ClientConfig, ServerConfig, Endpoint, Connection, Incoming};
...
impl Peer {
    ...
    pub async fn dial(&self, addr: SocketAddr, expected_peer: Option<&PeerId>) -> Result<(Connection, PeerId)> {
